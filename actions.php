...
require_once("includes/sanitize.php");
	...
	if (isset($_GET['action']) && $_GET['action']=="logout") {
		...
		$stm = $DBH->prepare("SELECT SID,email,lastemail,mfa,password FROM imas_users WHERE id=?");
		$stm->execute(array($userid));
		list($old_SID, $old_email,$lastemail,$lastmfa,$oldpw) = $stm->fetch(PDO::FETCH_NUM);
